const catalogueMenuTargets = [
    { project: "Europe", containerId: "dynamic-populated-menu-catalogue-view-expanse" },
    { project: "Netherlands", containerId: "dynamic-populated-menu-catalogue-view-exposome" }
];
